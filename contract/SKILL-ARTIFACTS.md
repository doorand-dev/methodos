...
| `plan-verify` | [plan-verify-reviewer](../agents/claude/plan-verify-reviewer.md) | opus | `<verify_root>/plan-<slug>-verify-attempt-N.json` | 4 dimension (A/B/C/D) |
| `impl-verify` | [impl-verify-reviewer](../agents/claude/impl-verify-reviewer.md) | opus | `<verify_root>/slice-<N>-attempt-<M>.json` | class-aware Stage 1(spec) + 필요한 Stage 2(quality) 순서 강제 |
...
### impl-verify schema (kind: "impl-verify") — class-aware Stage 1/2 (v1.2)
