...
| `impl-verify` | [impl-verify-reviewer](../agents/claude/impl-verify-reviewer.md) | opus | `<verify_root>/slice-<N>-attempt-M.json` | OMC code-reviewer 통합 패턴 — Stage 1(spec) + Stage 2(quality) 내부 순서 강제 |
