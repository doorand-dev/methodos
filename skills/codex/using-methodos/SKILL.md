...
Codex final attempt 1은 부모 session model/effort를 상속한 fresh local read-only
subagent다. DONE이면 종료하고 routine second round는 없다. BROKEN fix 뒤 attempt
2+만 fresh local Sol/medium scoped다. ChatGPT Pro나 Claude Fable/Opus 같은 외부 reviewer는 사용자가
